...
public final class EmbeddedChannelLocked: Channel {
    ...
    public var embeddedEventLoop: EmbeddedEventLoopLocked = EmbeddedEventLoopLocked()
    ...
    public convenience init(handler: ChannelHandler? = nil, loop: EmbeddedEventLoopLocked = EmbeddedEventLoopLocked()) {
    ...
    ///     - loop: The `EmbeddedEventLoop` to use.
    public init(handlers: [ChannelHandler], loop: EmbeddedEventLoopLocked = EmbeddedEventLoopLocked()) {
...
extension EmbeddedChannelLocked {
    public struct SynchronousOptions: NIOSynchronousChannelOptions {
        @usableFromInline
        internal let channel: EmbeddedChannelLocked

        fileprivate init(channel: EmbeddedChannelLocked) {
